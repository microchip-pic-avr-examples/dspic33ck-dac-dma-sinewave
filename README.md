...
This code example demonstrates how to generate a 100 Hz sine wave without CPU intervention using the DMA and DAC peripherals of the dsPIC33CK device. This demo is interchangable between the Explorer Board 16/32 with dsPIC33CK256MP508 PIM and the dsPIC33CK Curiosity development boards (with varying output pins). 
